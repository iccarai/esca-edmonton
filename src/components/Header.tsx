        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <a href="https://www.linkedin.com/company/el-salvador-cultural-association-of-edmonton-esca/" target="_blank" rel="noopener noreferrer" className="p-2 text-primary-foreground/60 hover:text-secondary transition-colors">
              ...
              <SheetContent side="right" className="bg-primary text-primary-foreground w-72">
                ...
                <nav className="flex flex-col gap-1 mt-8">
                  ...
                  <div className="flex items-center gap-4 px-4 mt-4 pt-4 border-t border-primary-foreground/10">
                    ...
                    <a href="https://www.linkedin.com/company/el-salvador-cultural-association-of-edmonton-esca/" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/60 hover:text-secondary">
